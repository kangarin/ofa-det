...
from train.train_detection_networks_with_kd_checkpoints_no_min_net import train
...
train(model, 100, 'ofa_mbv3_w12_fasterrcnn_kd_ckpt_200_mini.pth', max_net_config, min_net_config, batch_size=4,
